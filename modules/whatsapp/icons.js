/**
 * =====================================================
 * WhatsApp SVG Icons Module
 * Modern SVG icons for the WhatsApp interface
 * ===================================================== */

export const Icons = {
  // Composer icons
  emoji: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  attach: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0 0 18.8-4.3M22 12.5a10 10 0 0 0-18.8 4.2"></path>
  </svg>`,
  ...
  // Status icons
  sending: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="12" r="1"></circle>
    <circle cx="19" cy="12" r="1"></circle>
    <circle cx="5" cy="12" r="1"></circle>
  </svg>`,

  sent: `<svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"></path>
  </svg>`,

  delivered: `<svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"></path>
    <path d="M20 7l-1.41-1.41L9 16.17 4.83 12l-1.42 1.41L9 19 20 7z" opacity="0.5"></path>
  </svg>`,

  read: `<svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"></path>
    <path d="M20 7l-1.41-1.41L9 16.17 4.83 12l-1.42 1.41L9 19 20 7z" opacity="0.5"></path>
  </svg>`,

  failed: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="12" r="10"></circle>
  ...
  render(name, className = '') {
    ...
    return `<span class="wa-icon ${className}">${svg}</span>`;
  },
