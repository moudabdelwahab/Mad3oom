// ============================================================
// تشفير/فك تشفير مشترك لكل بيانات اعتماد MCP (AES-GCM + SHA-256
// من MCP_ENC_KEY + IV عشوائي 12 بايت + base64(iv || ciphertext)).
// نفس النمط المستخدم في manage-external-integration بالحرف.
// ============================================================
