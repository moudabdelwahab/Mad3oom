 ...
 * OAuth.
 *
 * الحاجز الفعلي في القاعدة: api_token_scope_ceiling() (الترحيل 036) ترجّع
 * سقفًا أضيق لحساب الشركة لا يشمل الثلاثة، و create-api-token ترفض أي
 * صلاحية خارج السقف. فالامتناع عن عرضها هنا **موافقة للسقف** لا بديل عنه.
 *
 * ملاحظة على الحالة الراهنة: الترحيل 036 مُطبَّق، لكن النسخة المُحصَّنة من
 * create-api-token في المستودع ولم تُنشَر بعد. فحتى يتم النشر، السقف مفروض
 * في القاعدة ومعلَن هنا، والدالة المنشورة ما زالت تقبل ما يُرسَل إليها —
 * وهو ما يجعل النشر خطوة مطلوبة لا تجميلية.
 */
