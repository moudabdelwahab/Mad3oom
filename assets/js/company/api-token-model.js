 ...
 *
 * الحالة: الترحيل 036 مُطبَّق، والنسخة المُحصَّنة من create-api-token منشورة
 * (v26). فالسقف مفروض فعليًا على الخادم الآن: أي صلاحية خارجه تُرفض بـ403
 * مهما أُرسلت، وإخفاؤها هنا موافقة للسقف لا بديل عنه.
 */
