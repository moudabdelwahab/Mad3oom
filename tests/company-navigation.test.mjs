...
test('لا ترحيل جديد بلا قرار صريح', () => {
    ...
    //   043 — مدوّنة المنصة. مطلوبة صراحةً من صاحب المنتج، ولا يمكن أن تكون
    //         تغيير واجهة: جمهور المدوّنة **زائر بلا جلسة**، وكل جدول محتوى
    //         قائم (knowledge_base خاصةً) مفتوح لـauthenticated وحدهم عن
    //         قصد. إعادة استعماله بعمود «عام/خاص» كانت ستجعل صفًّا واحدًا
    //         خاطئًا يكشف ملاحظات الدعم الداخلية للإنترنت؛ الفصل بجدول
    //         يجعل ذلك مستحيلًا بنيويًا. وإضافي بالكامل: لا يمسّ جدولًا ولا
    //         سياسة قائمة، والتراجع حذف الجدولين وحدهما.
    //         الكتابة محصورة في is_platform_staff() — أي لوحة الإدارة أو
    //         لوحة المالك وحدهما، ومقيسٌ في tests/sql/blog.test.sql.
    assert.equal(migrations[migrations.length - 1], '043_blog.sql',
