...
test('لا ترحيل جديد بلا قرار صريح', () => {
    ...
    //   053 — الملكية ليست «أدمن بصلاحيات أكثر» (معتمَد: «إدارة الإداريين للمالك
    //         وحده، حماية المالك من الحظر والحذف والتخفيض، سجل امتيازات، وتحقق
    ...
    //   055 — صندوق الرسائل كـ helpdesk، المرحلة 1 (معتمَد: «موافق على
    //         التوصيات كلها، ابدأ المرحلة الأولى» على docs/INBOX_HELPDESK_PLAN_AR.md،
    //         ثم «approve applying 054_inbox_helpdesk_core.sql» — الرقم صار 055
    //         لأن 054 أعلاه طُبِّق على الإنتاج قبله).
    //         الإسناد والفرق والملاحظات الداخلية لا مكان لها في الجداول
    //         القائمة: chat_sessions يعدّلها صاحب الجلسة بكل أعمدتها، و
    //         chat_messages يقرؤها العميل ويستمع لها الويدجت — فأي حالة فريق
    //         هناك يغيّرها العميل أو تتسرّب له. وقراءة الشات كانت للمرتفعين
    //         وحدهم، فالإسناد لغيرهم يحتاج سياسة SELECT مضافة (D1=C).
    //         مقيسٌ بضوابط سلبية في tests/sql/inbox-helpdesk-core.test.sql.
    //   056 — الصندوق، المرحلة 2 (معتمَد: «ابدأ المرحلة التانية»): مرفقات الدعم
    //         والتفاعلات الداخلية وتعديل/حذف ردود الدعم. العميل لا يقرأ من
