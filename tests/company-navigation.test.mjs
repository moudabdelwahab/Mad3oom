...
test('لا ترحيل جديد بلا قرار صريح', () => {
    ...
    //   043 — الشركة تُعرَف ببريد مالكها أيضًا في شاشة دخول العضو. مطلوب
    //         صراحةً من صاحب المنتج بعد عطل على الإنتاج: الترحيل 016 أسقط
    //         NOT NULL عن company_email و company_phone، فشركة أُنشئت من
    //         مسار الاشتراك لا يعرّفها إلا سجلها التجاري — ومالكها يكتب
    //         بريده هو كما يوحي نص الحقل، فتعود الدالة بـNULL ويُرفض عضو
    //         مسجَّل سليمًا. لا يمكن أن يكون تغيير واجهة: المطابقة نفسها
    //         داخل resolve_company_member_login، ولا تملك الواجهة قراءة
    //         companies أصلًا. إثبات العضوية وشرط الشركة الفعّالة وحدّ
    //         معدّل الطلبات كما هي حرفيًا — التوسعة في ما يُقبل كمعرّف
    //         للشركة، لا في ما يُرجَع.
    //         مقيسٌ في tests/sql/account-gate.test.sql (⑦C و⑦D).
    assert.equal(migrations[migrations.length - 1], '043_company_login_identifiers.sql',
